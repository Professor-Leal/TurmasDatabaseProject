...
import com.rafaelleal.android.turmasdatabaseproject.databinding.QueryAlunoListItemBinding
 ...
 */
class QueryAlunosAdapter(val listener: QueryAlunoListener) :
    ListAdapter<
            Aluno,
            QueryAlunosAdapter.ViewHolder
            >(QueryAlunoDiffCallback()) {
    ...
    class ViewHolder private constructor(
        val binding: QueryAlunoListItemBinding,
        val listener: QueryAlunoListener
        ...
        companion object {
            fun from(parent: ViewGroup, listener: QueryAlunoListener): ViewHolder {
                val layoutInflater = LayoutInflater.from(parent.context)
                val binding = QueryAlunoListItemBinding.inflate(
...
class QueryAlunoDiffCallback : DiffUtil.ItemCallback<Aluno>() {
...
interface QueryAlunoListener {
    fun onAddClick(aluno: Aluno)
}
